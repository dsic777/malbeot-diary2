        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center gap-3" style={{marginTop: '30px'}} autoComplete="off">
          ...
          <div className="w-[70%] flex flex-col gap-2">
            ...
            <input
              ...
              autoComplete="off"
              className="w-full bg-gray-900 border border-gray-700 rounded-md pr-4 py-7 text-xl text-white font-bold placeholder-gray-600 focus:outline-none focus:border-amber-400" style={{paddingLeft: '10px'}}
              required
            />
          </div>
          ...
          <div className="w-[70%]" style={{marginTop: '24px'}}>
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-green-400 hover:bg-green-500 text-white font-black rounded-md py-7 text-xl disabled:opacity-40 transition"
            >
              {loading ? '로그인 중...' : '로그인'}
            </button>
          </div>
