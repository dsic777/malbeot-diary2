  ...
  return (
    <div className="flex-1 bg-black flex flex-col">
      ...
      <header className="bg-black border-b border-gray-800 px-5 py-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <h1 className="text-2xl font-black text-white">말벗 설정</h1>
            ...
            {showCustomForm && (
              <form onSubmit={handleAddCustom} className="bg-gray-900 border border-amber-400 border-opacity-30 rounded-md p-4 flex flex-col gap-3">
                <input
                  ...
                  className="bg-black border border-gray-700 rounded-md py-2 text-2xl text-white font-bold placeholder-gray-600 focus:outline-none focus:border-amber-400"
                ...
                <textarea
                  ...
                  rows={3}
                  className="bg-black border border-gray-700 rounded-md py-2 text-2xl text-white font-bold placeholder-gray-600 focus:outline-none focus:border-amber-400 resize-none"
                  style={{paddingLeft: '10px'}}
                  required
                />
                <button
